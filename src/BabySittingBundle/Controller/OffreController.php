...
use BabySittingBundle\Entity\Offre;
...
class OffreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $offres = $em->getRepository('BabySittingBundle:Offre')->findAll();
    ...
    {
        $offre = new Offre();
        $form = $this->createForm('BabySittingBundle\Form\OffreType', $offre);
    ...
    {
        $deleteForm = $this->createDeleteForm($offre);
        $editForm = $this->createForm('BabySittingBundle\Form\OffreType', $offre);
