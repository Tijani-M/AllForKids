...
class NoteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $notes = $em->getRepository('SanteBundle:Note')->findAll();
    ...
    {
        $note = new Note();
        $form = $this->createForm('SanteBundle\Form\NoteType', $note);
    ...
    {
        $deleteForm = $this->createDeleteForm($note);
        $editForm = $this->createForm('SanteBundle\Form\NoteType', $note);
