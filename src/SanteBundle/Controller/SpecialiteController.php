...
class SpecialiteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $specialites = $em->getRepository('SanteBundle:Specialite')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('SanteBundle\Form\SpecialiteType', $specialite);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('specialite_index', array('idSpecial' => $specialite->getIdspecial()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($specialite);
        $editForm = $this->createForm('SanteBundle\Form\SpecialiteType', $specialite);
    ...
    private function createDeleteForm(Specialite $specialite)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('specialite_delete', array('idSpecial' => $specialite->getIdspecial())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
